...
class Crawler:
    ...
    def crawl_film(self, href: str, post_type: str = CONFIG.TYPE_SERIES):
        soup = self.crawl_soup(href)
    ...
    def crawl_page(self, url, post_type: str = CONFIG.TYPE_SERIES):
        ...
        for item in items:
            try:
                ...
                Kisscartoon(film_data, episodes_dict).insert_film()
